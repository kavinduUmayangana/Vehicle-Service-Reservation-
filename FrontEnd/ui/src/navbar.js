...
const Header = () => {
  ...
  return (
    <header className='fixed top-0 left-0 z-10 w-full shadow-md bg-blue-300' 
>
      <nav className='items-center justify-between py-4 md:flex md:px-10 px-7'>
        ...
        <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-blue-300 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in 
